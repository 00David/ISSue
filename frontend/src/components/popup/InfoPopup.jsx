	...
	return (
		<div className="fixed inset-0 flex items-center justify-center bg-black/50 z-1002">
			<div className="relative bg-midissue rounded-xl shadow-xl max-w-md w-full overflow-hidden
				...
				{/* Accent bar */}
				<div className="h-1.5 bg-linear-to-r bg-blue-500" />
				...
				<div className="p-6">
					...
					<button
						onClick={onClose}
						className="w-full bg-linear-to-r bg-blue-500 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-xl hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] transition-all"
					>
						OK
					</button>
				</div>
